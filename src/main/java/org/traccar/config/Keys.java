...
public final class Keys {
    ...
    public static final ConfigKey<String> CENTRALPERU_USERNAME =
            new StringConfigKey(
                    "centralperu.username",
                    List.of(KeyType.CONFIG));

    /**
     * Retranmsion HORTIFRUT PERU.
     */

    public static final ConfigKey<String> CENTRALPERU_PASSWORD =
            new StringConfigKey(
                    "centralperu.password",
                    List.of(KeyType.CONFIG));

    public static final ConfigKey<String> CENTRALPERU_API_KEY =
            new StringConfigKey(
                    "centralperu.apiKey",
                    List.of(KeyType.CONFIG));
