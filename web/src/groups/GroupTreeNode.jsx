    ...
    <Box sx={{ width: '100%', minWidth: 0 }}>
      ...
      >
        ...
        {hasChildren && (
          <Typography
            variant="caption"
            sx={{
              mr: 1, px: 0.75, py: 0.2, borderRadius: '6px',
              backgroundColor: ET.greenGlow, color: ET.green,
      ...
      {hasChildren && (
        <Collapse in={expanded} timeout={200}>
          <Box sx={{ width: '100%',
            minWidth: 0, borderLeft: `2px solid ${ET.greenGlow}`, ml: `${node.depth * INDENT_PX + 20}px` }}>
