...
// ── Carga inmediata — rutas críticas del flujo inicial ────────────────────────
...
const MonitoringHealthPage = lazy(
  () => import('./monitoring/MonitoringHealthPage'),
);
...
const Navigation = () => {
  ...
  if (hasQueryParams) return <Loader />;
      ...
      <Routes>
        ...
        <Route path="/" element={<App />}>
          ...
          <Route
            ...
            element={<MonitoringHealthPage />}
          />
          <Route
            path="monitoring/mantenimiento"
            element={<MonitoringMantenimientoPage />}
          />
          <Route
